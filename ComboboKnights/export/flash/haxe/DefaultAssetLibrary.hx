...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/keyboard/sBat_strip4.png", __ASSET__assets_images_keyboard_sbat_strip4_png);
		type.set ("assets/images/keyboard/sBat_strip4.png", AssetType.IMAGE);
		className.set ("assets/images/keyboard/x.png", __ASSET__assets_images_keyboard_x_png);
