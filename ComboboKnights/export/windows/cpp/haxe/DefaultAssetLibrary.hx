...
@:font("C:/HaxeToolkit/haxe/lime/flixel/3,3,11/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("C:/HaxeToolkit/haxe/lime/flixel/3,3,11/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends flash.text.Font {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/keyboard/sBat_strip4.png", "assets/images/keyboard/sBat_strip4.png");
		type.set ("assets/images/keyboard/sBat_strip4.png", AssetType.IMAGE);
		path.set ("assets/images/keyboard/x.png", "assets/images/keyboard/x.png");
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/keyboard/sBat_strip4.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/keyboard/x.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
